...
TARGET = Accreditation_Petrgu_ver0_003
TEMPLATE = app
...
LIBS += \
    ...
    #opencv4 lib
    "-L$$PWD../../opencv4/opencv/my-build-mingw/bin/" \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_core401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_highgui401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_imgcodecs401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_imgproc401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_features2d401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_calib3d401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_video401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_videoio401d.dll \
    #Дополнительные библиотеки для распознавания лиц
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_objdetect401d.dll \
    $$PWD../../opencv4/opencv/my-build-mingw/bin/libopencv_imgproc401.dll
