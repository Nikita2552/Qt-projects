...
void ipCamera::ipCameraConnect()
{
    ...
    DWORD portOut = this->InputData[4].toInt();
     ...
     this->lUserID = NET_DVR_Login_V30(strOut, portOut, loginOut, passwordOut, &struDeviceInfo); //8000, "operator", "Cvjnhbntkm12", &struDeviceInfo); //
     if (this->lUserID < 0)
     {
