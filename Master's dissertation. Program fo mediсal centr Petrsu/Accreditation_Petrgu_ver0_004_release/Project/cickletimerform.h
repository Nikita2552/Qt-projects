...
public slots:
    ...
    void textForNumberCickles(int numberCickles);
    void textForNumberCicklesMany(int numberCickles);

signals:

    void SwitchSignal(int DynamicNumber);

    void TimerToServerSignal(int NumberSignal, QVector <QString> parameters);
